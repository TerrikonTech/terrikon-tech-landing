...
export default function HeroSection({
  ...
  return (
    ...
    >
      {/* Запечённый прозрачный атлас: фон z-0, заголовок z-1,
          фигура z-2. Лама остаётся поверх букв, но mousemove больше
          не вызывает video seek и загрузку видеокадра в WebGL. */}
      <SubjectKeyCanvas
