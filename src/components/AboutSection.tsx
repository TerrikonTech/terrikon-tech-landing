...
const ABOUT_TEXT =
  'Мы — Террикон, студия разработки из Донецка. Никаких менеджеров-прослоек: вы говорите напрямую с теми, кто пишет код. Нас около двадцати — инженеры, дизайнеры, 3D и моушн — и мы ведём проект от макета до сервера.'
