...
const ABOUT_TEXT =
  'Мы — Террикон, студия разработки из Донецка. Создаём сайты под ключ, веб-приложения и цифровые сервисы для бизнеса в Донецке, ДНР и по всей России. Без менеджеров-прослоек: вы говорите напрямую с теми, кто пишет код. Ведём проект от идеи до запуска и поддержки.'
